...
export default function DashboardReportsClient() {
 ...
 <div className="mb-8">
 <h1 className="text-3xl font-semibold tracking-tight text-zinc-900">Saved reports</h1>
 ...
 <p className="text-sm font-semibold text-zinc-800">Saved Reports are part of Monthly Pro or Pro Report.</p>
 ...
 className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-lg border border-zinc-300 bg-white px-6 py-2.5 text-sm font-medium text-zinc-900 transition hover:bg-zinc-50"
 >
 ...
 {loading ? (
 <p className="p-8 text-sm text-zinc-500">Loading your reports…</p>
 ) : reports.length === 0 ? (
 <p className="p-8 text-sm leading-relaxed text-zinc-500">{emptyHint}</p>
 ) : (
 <div className="divide-y divide-zinc-200">
 <div className="hidden gap-4 px-6 py-3 text-[11px] font-semibold uppercase tracking-wider text-zinc-500 md:grid md:grid-cols-[minmax(0,1.4fr)_minmax(0,0.75fr)_minmax(0,0.55fr)_minmax(0,0.85fr)_auto]">
 ...
 <div className="mt-1 truncate text-xs text-zinc-500">{r.companyName?.trim() || 'None'}</div>
 </div>
 <div className="text-sm tabular-nums text-zinc-700/95">
 {typeof r.fitScore === 'number' ? `${r.fitScore}%` : 'None'}
 </div>
 <div className="text-xs font-semibold uppercase tracking-wide text-zinc-600">{r.statusLabel}</div>
 ...
 className="rounded-lg border border-zinc-300 bg-white px-4 py-2 text-xs font-medium text-zinc-900 transition hover:bg-zinc-50"
 >
 Open
 </Link>
 <button
 ...
 <div className="mt-8 rounded-2xl border border-dashed border-zinc-300/90 bg-zinc-50 p-4">
 <p className="text-[11px] font-semibold uppercase tracking-[0.18em] text-zinc-500">Billing sandbox</p>
 ...
 className="rounded-full border border-zinc-300 bg-white px-4 py-2 text-xs font-semibold text-zinc-800 hover:border-zinc-300"
 >
