    ...
    >
      ...
      <LegalSection id="general" heading="General approach">
        <p>
          ...
          <strong className="font-semibold text-zinc-900">limited</strong> accordingly. We handle requests case by case and
      ...
      <LegalSection id="monthly-pro" heading="Monthly Pro (subscription)">
        <p>
          ...
          <Link href="/terms" className="text-zinc-700 underline-offset-2 hover:underline">
            Terms
          </Link>
          ).
        </p>
